...
public class Constants {
    ...
    public static class CameraConstants {
        ...
        public static int RESOLUTION_X = RESOLUTION[0];
        public static int RESOLUTION_Y = RESOLUTION[1];
    ...
    public static class PipelineConstants {
        //Constants related strictly to the vision pipeline itself.
        ...
        public static int OFFSET_BORDER_MISSING = 20; //offset between border of view and red box
    }
